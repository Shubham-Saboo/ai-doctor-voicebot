...
input_text = "Hi, this is Shubham! How are you doing?"
text_to_speech_with_gtts(input_text=input_text,output_filepath="new_gtts_testing.mp3")
...
# text_to_speech_with_eleven_labs(input_text,output_filepath="new_elevenlabs_testing.mp3")